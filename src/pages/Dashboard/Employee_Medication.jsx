...
const EmployeeMediaction = () => {
  ...
  const options = [
    { value: "one", label: "Take 1 tab by mouth daily" },
    { value: "two", label: "Take 1 tab twice daily" },
    { value: "three", label: "Take 1 tab by mouth three times daily" },
    { value: "four", label: "Take 1 tab by mouth 4 times daily" },
    { value: "five", label: "Take 1 tab by mouth at bedtime" },
    {
      value: "six",
            ...
            <Table style={{ marginTop: "2rem", textAlign: "left" }} responsive>
              ...
              <tbody>
                <tr>
                  ...
                  >
                    <p>Take 1 slab by mouth daily</p>
                  </td>
...
export default EmployeeMediaction;
