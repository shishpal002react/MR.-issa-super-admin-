...
const SupportFAQ = () => {
  ...
  return (
    <>
      ...
      <div className="support-faq-page-container">
        <div className="support-faq-page-container1">
          <p
            style={{
              fontSize: "1.3rem",
              fontWeight: "600",
        ...
        <div className="support-faq-page-container2">
          <p
            style={{
              fontSize: "1.3rem",
              fontWeight: "600",
         ...
         <div>
          <Form>
            <Form.Group className="mb-3" controlId="formBasicCheckbox">
              ...
              <Form.Control disabled type="text" placeholder="Mon-Fri: 8:00am - 5:00pm MST" />
            </Form.Group>
            <Form.Group className="mb-3" controlId="formBasicCheckbox">
  <p style={{ fontSize: "1.3rem", fontWeight: "600", color: "#1A9FB2" }}>Technical Support:</p>
  <Form.Control disabled type="text" placeholder="208.543.66.46" className="custom-placeholder" />
</Form.Group>
            <Form.Group className="mb-3" controlId="formBasicCheckbox">
  <p style={{ fontSize: "1.3rem", fontWeight: "600", color: "#1A9FB2" }}>Schedule Training:</p>
  <Form.Control disabled type="text" placeholder="208.543.66.46" className="custom-placeholder" />
</Form.Group>
            <Form.Group className="mb-3" controlId="formBasicCheckbox">
  <p style={{ fontSize: "1.3rem", fontWeight: "600", color: "#1A9FB2" }}>Questions, Suggestions, or Comments:</p>
  <Form.Control disabled type="text" placeholder="team@oasisnotes.com" className="custom-placeholder" />
</Form.Group>
            <Form.Group className="mb-3" controlId="formBasicCheckbox">
  <Form.Label style={{ fontSize: "1.2rem", fontWeight: "600" }}>For after hours, emergency support please call:</Form.Label>
  <Form.Control disabled type="text" placeholder="0123456789" className="custom-placeholder" />
</Form.Group>
