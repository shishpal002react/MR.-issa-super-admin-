      ...
      <div>
        ...
        <div>
          <div>
            ...
            <div style={{ display: "flex", gap: "35px" ,flexWrap:"wrap",alignContent:"center"}}>
            <p>

                <img style={{ maxWidth: "50px", maxHeight: "50px",width:"auto",height:"auto" }} src="/notifiation.png" alt="notification" />
            </p>
            <p style={{ display: "flex", flexDirection: "row" ,flexWrap:"wrap",gap:"15px"}}>
